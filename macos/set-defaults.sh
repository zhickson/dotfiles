...
# Remove animation when switching desktops
echo "  › Remove the animation when switching desktops"
defaults write com.apple.dock workspaces-auto-swoosh -bool false

# Create 4 workspaces/desktops
echo "  › Create 4 workspaces/desktops"
defaults write com.apple.dock persistent-apps -array-add '{"tile-type"="small-grid";}'
defaults write com.apple.dock persistent-apps -array-add '{"tile-type"="small-grid";}'
defaults write com.apple.dock persistent-apps -array-add '{"tile-type"="small-grid";}'
defaults write com.apple.dock persistent-apps -array-add '{"tile-type"="small-grid";}'

# Bind the 4 workspaces/desktops to CTRL + 1, 2, 3, 4
echo "  › Bind the 4 workspaces/desktops to CTRL + 1, 2, 3, 4"
